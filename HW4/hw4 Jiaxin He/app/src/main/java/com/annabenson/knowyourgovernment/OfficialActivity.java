...
public class OfficialActivity extends AppCompatActivity {
    ...
    public static final String NO_DATA = "No Data"; // for else
    public static final String UNKNOWN = "Unknown"; // for party
    public static final String DEM = "Democratic Party";
    public static final String DEM2 = "Democrat"; // Rahm Emanuel
    public static final String GOP = "Republican Party";
        ...
        */
        ...
        if( official.getParty().equals(UNKNOWN)){ hideView(partyView);}
            ...
            if(official.getParty().equals(DEM) || official.getParty().equals(DEM2)){
                ...
                logoView.setImageResource(R.drawable.dem_logo);
            ...
            if(official.getParty().equals(GOP)){
                ...
                logoView.setImageResource(R.drawable.rep_logo);
                logoView.setVisibility(View.VISIBLE);
        ...
        if(official.getParty().equals(DEM) || official.getParty().equals(DEM2)){
            ...
            try {
                ...
                startActivity(new Intent(Intent.ACTION_VIEW,
                        ...
                        Uri.parse("https://democrats.org")));

            }
        }else if(official.getParty().equals(GOP)) {
            Intent intent;
            try {
                intent = new Intent(Intent.ACTION_VIEW);
