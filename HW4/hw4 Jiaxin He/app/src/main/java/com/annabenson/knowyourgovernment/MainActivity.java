    ...
    public void doLocationWork(double latitude, double longitude) {
        ...
        //for (int times = 0; times < 3; times++) {
            ...
            try {
               ...
               OfficialLoader officialLoader = new OfficialLoader(this,zip,handler);
                officialLoader.start();
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                String input = et.getText().toString();
                 OfficialLoader officialLoader = new OfficialLoader(mainActivity,input,handler);
                officialLoader.start();
